            ...
            <Form {...userForm}>
              <form onSubmit={userForm.handleSubmit(onUserSubmit)} className="space-y-4">
                <div className="flex justify-center mb-6">
                  <div className="relative w-24 h-24 rounded-full overflow-hidden bg-gray-200 flex items-center justify-center">
                    ...
                    <input
                      ...
                      disabled={uploading}
                    />
                    <div className="absolute bottom-0 left-0 right-0 bg-gray-800 bg-opacity-50 text-white text-xs text-center py-1">
                      {uploading ? '読込中...' : '写真を選択'}
                    </div>
                  </div>
                </div>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">ユーザー名 <span className="text-pink-500">*</span></FormLabel>
                      <FormControl>
                        <Input 
                          {...field} 
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">生年月日 <span className="text-pink-500">*</span></FormLabel>
                      <FormControl>
                        <Input 
                          type="date" 
                          {...field} 
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">性別 <span className="text-pink-500">*</span></FormLabel>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">都道府県 <span className="text-pink-500">*</span></FormLabel>
                      <FormControl>
                        <Input 
                          {...field} 
                          className="border-gray-300 focus:border-pink-500"
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">市区町村 <span className="text-pink-500">*</span></FormLabel>
                      <FormControl>
                        <Input 
                          {...field} 
                          className="border-gray-300 focus:border-pink-500"
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">自己紹介</FormLabel>
                      <FormControl>
                        <Textarea 
                          {...field} 
                          className="border-gray-300 focus:border-pink-500 min-h-[100px]"
                ...
                <Button type="submit" className="w-full bg-pink-500 hover:bg-pink-600 text-white py-2.5 mt-4">
                  次へ
                </Button>
              </form>
            </Form>
            ...
            <Form {...dogForm}>
              <form onSubmit={dogForm.handleSubmit(onDogSubmit)} className="space-y-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">愛犬の名前 <span className="text-pink-500">*</span></FormLabel>
                      <FormControl>
                        <Input 
                          {...field} 
                          className="border-gray-300 focus:border-pink-500"
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">犬種 <span className="text-pink-500">*</span></FormLabel>
                      <FormControl>
                        <Input 
                          {...field} 
                          className="border-gray-300 focus:border-pink-500"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-gray-700">年齢（歳）<span className="text-pink-500">*</span></FormLabel>
                        <FormControl>
                          <Input 
                            type="number" 
                            min="0" 
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-gray-700">月齢</FormLabel>
                        <FormControl>
                          <Input 
                            type="number" 
                            min="0" 
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">サイズ <span className="text-pink-500">*</span></FormLabel>
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        <FormControl>
                          <SelectTrigger className="border-gray-300 focus:border-pink-500">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-700">愛犬の紹介</FormLabel>
                      <FormControl>
                        <Textarea 
                          {...field} 
                          className="border-gray-300 focus:border-pink-500 min-h-[100px]"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-gray-700">ワクチン接種済み <span className="text-pink-500">*</span></FormLabel>
                        <FormControl>
                          <Select
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-gray-700">去勢・避妊済み <span className="text-pink-500">*</span></FormLabel>
                        <FormControl>
                          <Select
                            onValueChange={(value) => field.onChange(value === 'true')}
                            defaultValue={field.value?.toString()}
